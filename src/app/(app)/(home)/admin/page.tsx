...
import StageMediaUpload from "@/components/stage-media-upload";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-foreground">{isAdmin ? "Admin Panel" : "Manager Panel"}</h1>
            ...
            <TabsContent value="users" className="space-y-6">
                  ...
                  <div className="grid gap-4">
                    {filteredUsers
                      ...
                      .map((user) => (
                        <Card
                          key={user.id}
                          className="hover:shadow-md transition-shadow duration-200 border-l-4 border-l-red-500"
                        >
              ...
              {filteredUsers.length === 0 && (
                <div className="text-center py-12">
                  ...
                  {!searchTerm && <Button onClick={() => setShowCreateUser(true)}>Create First User</Button>}
                </div>
              )}
          ...
          {canManageContent && (
            <TabsContent value="categories" className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                {canManageContent && <Button onClick={() => setShowCreateCategory(true)}>Add Category</Button>}
              </div>
              <div className="grid gap-4">
          ...
          {canManageContent && (
            <TabsContent value="equipment" className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  {canManageContent && <Button onClick={() => setShowCreateEquipment(true)}>Add Equipment</Button>}
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {canManageContent && (
                            <>
                              ...
                              <Button variant="destructive" size="sm" onClick={() => deleteEquipment(item.id)}>
                                Delete
                              </Button>
                            </>
                          )}
          ...
          {canManageContent && (
            <TabsContent value="stages" className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  {canManageContent && <Button onClick={() => setShowCreateStage(true)}>Add Stage</Button>}
                  ...
                  <Card key={item.id}>
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <Badge variant={item.status === "indoor" ? "default" : "secondary"}>{item.status}</Badge>
                          {canManageContent && (
                            <>
                              <Button
                                variant="outline"
                              ...
                              <Button variant="destructive" size="sm" onClick={() => deleteStage(item.id)}>
                                Delete
                              </Button>
                            </>
                          )}
        ...
        {canManageContent && (
          <Modal isOpen={showCreateEquipment} onClose={() => setShowCreateEquipment(false)} title="Create Equipment">
            <div className="space-y-4">
              <div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => setNewEquipment({ ...newEquipment, categoryId: value })}
                >
                  <SelectTrigger>
        ...
        {canManageContent && (
          <Modal isOpen={showEditEquipment} onClose={() => setShowEditEquipment(false)} title="Edit Equipment">
            {editingEquipment && (
              <div className="space-y-4">
                <div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setEditingEquipment({ ...editingEquipment, categoryId: value })}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select a category" />
                    </SelectTrigger>
        ...
        {/* Create Stage Modal */}
        {canManageContent && (
          <Modal isOpen={showCreateStage} onClose={() => setShowCreateStage(false)} title="Create Stage">
            <div className="space-y-4">
              <div>
              ...
              <div>
                <Label htmlFor="stageStatus">Type</Label>
                <Select
                  value={newStage.status}
                  onValueChange={(value: "indoor" | "outdoor") => setNewStage({ ...newStage, status: value })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
        ...
        {/* Edit Stage Modal */}
        {canManageContent && (
          <Modal isOpen={showEditStage} onClose={() => setShowEditStage(false)} title="Edit Stage">
            {editingStage && (
              <div className="space-y-4">
                <div>
                ...
                <div>
                  <Label htmlFor="editStageStatus">Type</Label>
                  <Select
                    value={editingStage.status}
                    onValueChange={(value: "indoor" | "outdoor") => setEditingStage({ ...editingStage, status: value })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
