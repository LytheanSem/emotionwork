...
export default function ControlsPanel({
  selectedEquipment,
  // Removed unused: equipment, designName
  rotateSelected,
  scaleSelected,
  setScaleValue,
  resetScale,
          ...
          <>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-1 mt-2">
                <Button variant="outline" size="sm" onClick={moveUpSelected} className="flex-1">
                  <ArrowUp className="h-3 w-3 mr-1" /> Up
                </Button>
                <Button variant="outline" size="sm" onClick={moveDownSelected} className="flex-1">
                  <ArrowDown className="h-3 w-3 mr-1" /> Down
                </Button>
                <Button variant="outline" size="sm" onClick={moveLeftSelected} className="flex-1">
                  <ArrowLeft className="h-3 w-3 mr-1" /> Left
                </Button>
                <Button variant="outline" size="sm" onClick={moveRightSelected} className="flex-1">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Slider
                    ...
                    className="flex-1"
                  />
                  <span className="text-sm font-mono w-12 text-gray-600">{selectedEquipment.scale[0].toFixed(1)}</span>
                </div>
              </div>
              ...
              {(["x", "y", "z"] as const).map((axis, index) => (
                <div key={axis}>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Button variant="outline" size="sm" onClick={() => scaleSelected(axis, -0.1)}>
              ...
              <div className="grid grid-cols-3 gap-1">
                <Button variant="outline" size="sm" onClick={() => setScaleValue("all", 0.5)}>
                  50%
                </Button>
                <Button variant="outline" size="sm" onClick={() => setScaleValue("all", 1)}>
                  100%
                </Button>
                <Button variant="outline" size="sm" onClick={() => setScaleValue("all", 2)}>
                  200%
                </Button>
              </div>
            </div>
            ...
            {/* Rotation */}
            <Button variant="outline" className="w-full" onClick={rotateSelected}>
        ...
        <div className="border-t pt-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button onClick={scaleDesignToVenue} className="w-full" variant="outline">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500">Toggle the entire venue boundary cube (walls, floor, and lines)</p>
              </div>
              <Switch
            ...
            {selectedEquipment &&
              ["light", "ledPar", "movingHead", "strobe", "laser"].includes(selectedEquipment.type) && (
                <div className="space-y-3">
                  <div className="space-y-1">
                    <Label htmlFor="lighting-color">Lighting Animation Color</Label>
                    <p className="text-sm text-gray-500">
                      Choose the color for{" "}
                      {selectedEquipment.type === "light"
                        ? "Stage Light"
                        : selectedEquipment.type === "ledPar"
                          ? "LED Par"
                          : selectedEquipment.type === "movingHead"
                            ? "Moving Head"
                            : selectedEquipment.type === "strobe"
                              ? "Strobe"
                              : selectedEquipment.type === "laser"
                                ? "Laser"
                                : "Lighting"}{" "}
                      animations
                    </p>
              ...
              [
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Choose the color for{" "}
                      {selectedEquipment.type === "platform"
                        ? "Platform"
                        : selectedEquipment.type === "stageRiser"
                          ? "Stage Riser"
                          : selectedEquipment.type === "backdrop"
                            ? "Backdrop"
                            : selectedEquipment.type === "curtain"
                              ? "Curtain"
                              : selectedEquipment.type === "barricade"
                                ? "Barricade"
                                : selectedEquipment.type === "scaffolding"
                                  ? "Scaffolding"
                                  : selectedEquipment.type === "videoScreen"
                                    ? "Video Screen"
                                    : selectedEquipment.type === "ledWall"
                                      ? "LED Wall"
                                      : selectedEquipment.type === "smoke"
                                        ? "Smoke Machine"
                                        : selectedEquipment.type === "fog"
                                          ? "Fog Machine"
                                          : selectedEquipment.type === "hazer"
                                            ? "Hazer"
                                            : selectedEquipment.type === "bubbleMachine"
                                              ? "Bubble Machine"
                                              : selectedEquipment.type === "confettiCannon"
                                                ? "Confetti Cannon"
                                                : selectedEquipment.type === "speaker"
                                                  ? "Speaker"
                                                  : selectedEquipment.type === "djBooth"
                                                    ? "DJ Booth"
                                                    : selectedEquipment.type === "mixer"
                                                      ? "Mixer"
                                                      : selectedEquipment.type === "amplifier"
                                                        ? "Amplifier"
                                                        : selectedEquipment.type === "generator"
                                                          ? "Generator"
                                                          : selectedEquipment.type === "ups"
                                                            ? "UPS"
                                                            : "Equipment"}
                    </p>
                  </div>
